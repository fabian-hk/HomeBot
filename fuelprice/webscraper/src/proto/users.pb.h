...
#ifndef GOOGLE_PROTOBUF_INCLUDED_users_2fusers_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_users_2fusers_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_users_2fusers_2eproto
...
struct TableStruct_users_2fusers_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_users_2fusers_2eproto;
namespace users {
class FuelPrice;
...
class User :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_users_2fusers_2eproto);
    return ::descriptor_table_users_2fusers_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::users::FuelPrice >*
      mutable_fuel_prices();
  const ::users::FuelPrice& fuel_prices(int index) const;
  ::users::FuelPrice* add_fuel_prices();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::users::FuelPrice >&
      fuel_prices() const;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 fuel_kind() const;
  void set_fuel_kind(::PROTOBUF_NAMESPACE_ID::int32 value);

  // optional int32 privs = 3 [default = 3];
  bool has_privs() const;
  void clear_privs();
  static const int kPrivsFieldNumber = 3;
  ::PROTOBUF_NAMESPACE_ID::int32 privs() const;
  void set_privs(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::users::FuelPrice > fuel_prices_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr username_;
  ::PROTOBUF_NAMESPACE_ID::int64 chat_id_;
  double longitude_;
  double latitude_;
  ::PROTOBUF_NAMESPACE_ID::int32 fuel_kind_;
  ::PROTOBUF_NAMESPACE_ID::int32 privs_;
  double price_limit_;
  double lowest_price_;
  friend struct ::TableStruct_users_2fusers_2eproto;
};
// -------------------------------------------------------------------

class FuelPrice :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:users.FuelPrice) */ {
 public:
  FuelPrice();
  virtual ~FuelPrice();
  ...
  FuelPrice* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class UserManagement :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:users.UserManagement) */ {
 public:
  UserManagement();
  ...
  UserManagement* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 User::chat_id() const {
  // @@protoc_insertion_point(field_get:users.User.chat_id)
  return chat_id_;
}
inline void User::set_chat_id(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000002u;
  chat_id_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 User::privs() const {
  // @@protoc_insertion_point(field_get:users.User.privs)
  return privs_;
}
inline void User::set_privs(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000020u;
  privs_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 User::fuel_kind() const {
  // @@protoc_insertion_point(field_get:users.User.fuel_kind)
  return fuel_kind_;
}
inline void User::set_fuel_kind(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000010u;
  fuel_kind_ = value;
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::users::FuelPrice >*
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::users::FuelPrice >&
...
inline std::string* FuelPrice::release_street() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return street_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_users_2fusers_2eproto
